...
Validate the local project setup before starting work. This skill is **read-only**: it checks and reports, and never creates, edits, or deletes anything — no files, no branches, no config.
