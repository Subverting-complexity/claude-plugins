...
Do not make code changes during a security audit. Report findings only. Use `/local-workflow:build` or `/local-workflow:report-issue` to address individual findings.
