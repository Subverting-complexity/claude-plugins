...
Do not make code changes during a security audit. Report findings only. Use `/github-workflow:execute` or `/github-workflow:report-issue` to address individual findings.
