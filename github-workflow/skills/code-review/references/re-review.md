...
Read this when the SKILL's **Step 4b** trigger fires: the PR being
reviewed was **previously reviewed** (a prior review comment with a footer
exists). Skip — and never load — this for first-time reviews; that is why
it lives outside `SKILL.md`.
